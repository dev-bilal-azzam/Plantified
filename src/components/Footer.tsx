    ...
    <footer className="w-full bg-brand-bg pt-12 flex flex-col items-center">
      ...
      <div className="w-full max-w-7xl bg-brand-dark text-white rounded-3xl p-12 text-center relative overflow-hidden mb-12 shadow-2xl">
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-2">
          <h2 className="text-[20px] md:text-[28px] font-medium text-[#FFFFFF]/[0.88] font-poppins">Find the plant that grows with you.</h2>
          ...
          <form className="flex flex-col sm:flex-row gap-2 w-[90%] pt-4" onSubmit={(e) => e.preventDefault()}>
            <input
              type="email"
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center gap-4 py-4 px-8 mt-4 bg-brand-dark text-sm text-white">
